...
kidney_model = tf.keras.models.load_model(r"/models/kidney_best.h5")
pneumonia_model = tf.keras.models.load_model(r"/models/chest_best.h5")
knee_model = tf.keras.models.load_model(r"/models/XceptionModels/improved-48-0.84.keras")
...
cfg.MODEL.WEIGHTS = r"/models/output/detection_model.pth"
